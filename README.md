...
3. Remember to make sure you record the travel time of the hand or the wrist as my hypothesis is that the Machine Learning model should differentiate between the travel time and the actual guester.
